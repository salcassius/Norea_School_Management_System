...
<template>
  ...
  >
    ...
    <nav class="flex-1 py-6 px-3 space-y-2 overflow-y-auto custom-scrollbar">
      ...
      <button
        @click="handleLogout"
        class="relative flex items-center w-full h-11 rounded-xl text-rose-400 hover:text-white hover:bg-rose-900/30 transition-all px-3 mt-4"
      >
...
<script setup>
import { 
  LayoutDashboard, Users, ClipboardCheck, School, 
  FileCheck, CalendarDays, CalendarRange, BarChart3, 
  Settings, LogOut 
} from 'lucide-vue-next'
